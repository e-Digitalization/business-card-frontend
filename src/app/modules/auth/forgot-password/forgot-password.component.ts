...
import { BrandHeaderComponent } from 'app/shared/brand-header/brand-header.component';
import { BrandFooterComponent } from 'app/shared/brand-footer/brand-footer.component';
