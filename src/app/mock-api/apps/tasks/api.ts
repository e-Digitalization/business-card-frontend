...
import { FtmMockApiUtils } from '@ftm/lib/mock-api/mock-api.utils';
import {
    tags as tagsData,
    tasks as tasksData,
    ...
    registerHandlers(): void {
        ...
        this._ftmMockApiService
            ...
            .reply(({ request }) => {
                ...
                // Generate a new GUID
                newTag.id = FtmMockApiUtils.guid();
        ...
        // @ Tasks - GET
        // -----------------------------------------------------------------------------------------------------
        this._ftmMockApiService.onGet('api/apps/tasks/all').reply(() => {
            // Clone the tasks
