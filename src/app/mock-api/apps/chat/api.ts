...
export class ChatMockApi {
    ...
    registerHandlers(): void {
        ...
        // @ Chats - GET
        // -----------------------------------------------------------------------------------------------------
        this._ftmMockApiService.onGet('api/apps/chat/chats').reply(() => {
            // Clone the chats
        ...
        // @ Contacts - GET
        // -----------------------------------------------------------------------------------------------------
        this._ftmMockApiService.onGet('api/apps/chat/contacts').reply(() => {
            // Clone the contacts
        ...
        // @ Profile - GET
        // -----------------------------------------------------------------------------------------------------
        this._ftmMockApiService.onGet('api/apps/chat/profile').reply(() => {
            // Clone the profile
