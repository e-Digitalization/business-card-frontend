    ...
    registerHandlers(): void {
        ...
        this._ftmMockApiService
            ...
            .reply(({ request }) => {
                ...
                const isUsernameMatch = request.body?.username === '0763810289';
                const isPasswordMatch = request.body?.password === 'admin';
        ...
        // @ Sign up - POST
        // -----------------------------------------------------------------------------------------------------
        this._ftmMockApiService.onPost('api/auth/sign-up', 1500).reply(() =>
            // Simply return true
            [200, true]
        );
