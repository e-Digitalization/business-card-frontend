            ...
            const schemeCustomProps = _.map(
                ...
                (colorScheme) => {
                    ...
                    const background = theme(
                        `ftm.customProps.background.${colorScheme}`
                    );
                    const foreground = theme(
                        `ftm.customProps.foreground.${colorScheme}`
                    );
                        ...
                        _.flatten(
                            _.map(
                                ...
                                (name) => [
                                    [
                                        name,
                                        `rgba(var(--ftm-${name}-rgb), <alpha-value>)`,
                                    ],
                                    [
                                        `on-${name}`,
                                        `rgba(var(--ftm-on-${name}-rgb), <alpha-value>)`,
                                    ],
                                ]
                            )
                        )
