...
import { FtmMockApiReplyCallback } from '@ftm/lib/mock-api/mock-api.types';
import { Observable, of, take, throwError } from 'rxjs';

export class FtmMockApiHandler {
    request!: HttpRequest<any>;
    urlParams!: { [key: string]: string };

    // Private
    private _reply: FtmMockApiReplyCallback = undefined;
     ...
     * @param callback
     */
    reply(callback: FtmMockApiReplyCallback): void {
        // Store the reply
