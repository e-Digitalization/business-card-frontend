...
@Component({
    selector: 'ftm-vertical-navigation-collapsable-item',
    ...
    imports: [
        ...
        forwardRef(() => FtmVerticalNavigationCollapsableItemComponent),
...
export class FtmVerticalNavigationCollapsableItemComponent
    ...
    @HostBinding('class') get classList(): any {
        /* eslint-disable @typescript-eslint/naming-convention */
        return {
            'ftm-vertical-navigation-item-collapsed': this.isCollapsed,
            'ftm-vertical-navigation-item-expanded': this.isExpanded,
        };
        /* eslint-enable @typescript-eslint/naming-convention */
    }
    ...
    ngOnInit(): void {
        ...
        this._ftmVerticalNavigationComponent.onCollapsableItemCollapsed
        ...
        if (this.autoCollapse) {
            this._ftmVerticalNavigationComponent.onCollapsableItemExpanded
                .pipe(takeUntil(this._unsubscribeAll))
    ...
    collapse(): void {
        ...
        this._ftmVerticalNavigationComponent.onCollapsableItemCollapsed.next(
            this.item
        );
    }
    ...
    expand(): void {
        ...
        // Execute the observable
        this._ftmVerticalNavigationComponent.onCollapsableItemExpanded.next(
            this.item
        );
    }
