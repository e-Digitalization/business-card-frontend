...
export class FtmNavigationService {
    private _componentRegistry: Map<string, any> = new Map<string, any>();
    private _navigationStore: Map<string, FtmNavigationItem[]> = new Map<
        string,
        any
    >();
     ...
     * @param navigation
     */
    storeNavigation(key: string, navigation: FtmNavigationItem[]): void {
        // Add to the store
     ...
     * @param key
     */
    getNavigation(key: string): FtmNavigationItem[] {
     ...
     */
    getFlatNavigation(
        navigation: FtmNavigationItem[],
        flatNavigation: FtmNavigationItem[] = []
    ): FtmNavigationItem[] {
    ...
    getItemParent(
        id: string,
        navigation: FtmNavigationItem[],
        parent: FtmNavigationItem[] | FtmNavigationItem
    ): FtmNavigationItem[] | FtmNavigationItem | null {
        for (const item of navigation) {
            if (item.id === id) {
                return parent;
            }
