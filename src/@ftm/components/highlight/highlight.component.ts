...
import { FtmHighlightService } from '@ftm/components/highlight/highlight.service';

@Component({
    selector: 'textarea[ftm-highlight]',
    templateUrl: './highlight.component.html',
    styleUrls: ['./highlight.component.scss'],
    encapsulation: ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush,
    exportAs: 'ftmHighlight',
    imports: [NgClass],
})
export class FtmHighlightComponent implements OnChanges, AfterViewInit {
    private _domSanitizer = inject(DomSanitizer);
    private _elementRef = inject(ElementRef);
    private _ftmHighlightService = inject(FtmHighlightService);
    ...
    private _highlightAndInsert(): void {
        ...
        this.highlightedCode = this._domSanitizer.sanitize(
            ...
            this._ftmHighlightService.highlight(this.code, this.lang)
        );
